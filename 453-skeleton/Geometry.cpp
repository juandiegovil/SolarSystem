...
void GPU_Geometry::setCols(const std::vector<glm::vec2>& cols) {
	colorsBuffer.uploadData(sizeof(glm::vec2) * cols.size(), cols.data(), GL_STATIC_DRAW);
}
